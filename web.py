...
@app.route('/v2/service_instances/<simple:instance_id>/service_bindings/<simple:binding_id>', methods=['DELETE'])
def binding_delete(instance_id, binding_id):
    return make_response(jsonify({}), 200)


@app.route('/v2/service_instances/<simple:instance_id>/service_bindings/<simple:binding_id>', methods=['PUT'])
